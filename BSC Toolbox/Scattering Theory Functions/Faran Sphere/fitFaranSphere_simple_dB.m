function [bsc_faran,param_faran] = fitFaranSphere_simple_dB(bsc,f,arange,param)
%FITFARANSPHERE Fit the Faran sphere form factor BSC.
% Same as fitFaranSphere_simple, except the bsc is already in dB and the
% frequency dependence has been removed
% INPUTS:
%   bsc = backscatter coefficient [dB/str/m]
...
bsc2_dB = bsc;
% The next two lines are uncommented in the original version
% bsc_dB = 10*log10(bsc);
