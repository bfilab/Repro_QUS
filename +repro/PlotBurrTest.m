function PlotBurrTest(day, qus_results_fid,frame_num)
...
%     end
    ...
    if strcmp(qus_params_to_plot{p_count},'Burr lambda')
        this_p_map = log10(this_p_map);
    elseif strcmp(qus_params_to_plot{p_count},'Burr b')
        this_p_map = log10(this_p_map);
    end
