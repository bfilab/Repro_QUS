function BurrTestWholeImage(in_fid,qus_frames,qus_save_str)
...
%                 %}
                ...
                result{param2idx(params,'Burr b')}(k,i,j) = b_fit;
                result{param2idx(params,'Burr lambda')}(k,i,j) = lambda_fit;
...
%         save('.\qus_results.mat','result','params')
    ...
    save(save_results_str,'result','params', ...
